...
public class HandViewModelTests
{
    ...
    {
        var hand = new HandViewModel(ComputeLayout().LeftHand, false, MakeLayer());
    ...
    {
        var hand = new HandViewModel(ComputeLayout().RightHand, true, MakeLayer());
        Assert.Equal(4, hand.FingerClusters.Count);
    }
    ...
    public void EmptyKeys_DoesNotThrow()
    {
        ...
        var hand = new HandViewModel(emptyHand, false, MakeLayer());
